...
//  indicar en el formulario que genera una peticion POST  
    ...
    public String procesarFormulario(@ModelAttribute Empleado empleado, ModelMap model) {
        try {
...
//  Metodo para modificar empleados    
    ...
    public String modificarEmpleado(@ModelAttribute Empleado empleado, ModelMap model) {
        model.put("empleado", empleadoServicio.getOne(empleado.getId()));
        return "empleados/modificarEmpleado";
    }

    @PostMapping("/modificar/{id}")//empleado/listaEmpleados
    public String guardarCambiosEmpleado(@PathVariable String id, @RequestParam String nuevoNombre, @RequestParam String nuevoApellido, @RequestParam String nuevoUsuario, @RequestParam String nuevoDocumento, @RequestParam String nuevaClave, ModelMap model) {
        try {
